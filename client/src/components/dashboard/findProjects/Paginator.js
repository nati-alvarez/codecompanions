...
class Paginator extends Component {
    render(){
        ...
        //will show buttons for the next five pages of projects
        while(pagesInArray < 5){
            ...
            if((this.props.projects.length / itemsPerPage) - this.props.page < 4){
                //exludes negative values and 0 if the number of pages needed is less than 5
                if(Math.ceil(this.props.projects.length / itemsPerPage - pagesInArray) <= 0){
                    pagesInArray++;
                    continue;
                }
                pages.push(Math.ceil(this.props.projects.length / itemsPerPage - pagesInArray));
                pages.sort();
                ++pagesInArray;
                continue;
            }
        ...
        return (    
            this.props.projects.length > itemsPerPage &&
            <div className="pagination-buttons">
                ...
                {!(itemsPerPage * this.props.page >= this.props.projects.length) &&
